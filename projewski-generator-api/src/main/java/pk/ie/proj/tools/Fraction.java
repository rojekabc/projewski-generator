...
public class Fraction
{
	...
	public Fraction(long a, long b, long c)
	{
		long gcd;
		_a = a;
		if ( c<0 )
	...
	{
		Fraction f2 = new Fraction(_a*f._b, f._c);
		Fraction f3 = new Fraction(_b*f._b, _c*f._c);
		_a *= f._a;
		_b *= f._a;
		if ( _b != 0 ) 
		{
	...
	public void div(Fraction f)
	{
		...
		if ( f._b == 0 )
			...
			tc2 = f._c;
		Fraction tmp = new Fraction(tc2*(_a*tc1+_b), tc1*(f._a*tc2+f._b));
		_a = tmp._a;
		_b = tmp._b;
		_c = tmp._c;
	}
