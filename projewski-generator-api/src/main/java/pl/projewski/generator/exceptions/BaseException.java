...
public abstract class BaseException
     ...
     */
    private static final String internal = "IE ! "; // do usunięcia
    /**
     * nienazwany błąd
     */
     ...
     */
    public BaseException(final int index) {
     ...
     */
    public BaseException(final int index, final String[] args) {
        build(index, args);
    }
     ...
     */
    public BaseException(final int index, final String arg) {
     ...
     * @param errorString
     */
    public BaseException(final String errorString) {
        errCode = -1;
     ...
     */
    private void build(final int errorIndex, final String[] args) {
        errCode = errorIndex;
        descr = "TO CHANGE AND FIX !!!";
